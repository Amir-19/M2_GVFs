# on-policy question with state-depandent gamma for Robot Module 2
# author: amir samani
...
def main():
    ...
    while True:
        ...
        servo1_data.append([t, ang * 10, theta[state_prime], gamma(state_prime) * 3, cummlant(state_prime) *6, dv_pred, dv_ver])
...
def signal_handler(signal, frame):
    ...
    np.savetxt('q2_data.txt', np_servo1_data)
